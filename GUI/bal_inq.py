...
# Insert Instructions for User
goBack = Label(window, text="Go back to Transaction?", font=("Arial", 16), fg='#162F65', bg="#E7E6DD")
goBack.place(x=340, y=390)

exit_border = Frame(window, highlightbackground = "#651616", highlightthickness = 2, bd=0)
exit = Button(exit_border, text='EXIT', fg='white', bg='#AC3333', font='bold', height=1, width=7)
exit.pack()
